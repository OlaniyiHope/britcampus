...
export default function Signup(): JSX.Element {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log({ firstName, lastName, email, phone, programme });
  };
        ...
        <div className="auth-form-side">
          <div className="auth-card">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="btn btn-gold btn-block" style={{ marginTop: 12 }}><i className="fas fa-arrow-right"></i> Create Account &amp; Continue</button>
            </form>
